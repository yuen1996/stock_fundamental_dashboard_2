...
# --- unified page CSS (same look as Systematic Decision; dark sidebar) ---
BASE_CSS = """
<style>
:root{
  --bg:#f6f7fb;
...
/* Darken sidebar controls */
[data-testid="stSidebar"] .stTextInput > div > div,
[data-testid="stSidebar"] .stPassword > div > div,
...
[data-testid="stSidebar"] .stPassword input,
...
/* Sticky chat/table headers if you add them later */
div[data-testid="stDataFrame"] table thead th{
  position:sticky; top:0; background:#f9fafb !important; z-index:10;
}
</style>
"""
