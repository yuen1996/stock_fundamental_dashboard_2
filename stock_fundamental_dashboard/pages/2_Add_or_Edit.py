    ...
    for name in sorted(all_rows["Name"].dropna().unique()):
        ...
        with st.expander(name, expanded=False):
            ...
            with tabs[0]:
                ...
                base_a = ["Delete", "Name", "Industry", "Year"]
                extra_a = [
            ...
            with tabs[1]:
                ...
                base_q = ["Name", "Industry", "Year", "Quarter"]
                extra_q = [
                ...
                if submit_q:
                    ...
                    for _, r in valid.iterrows():
                        ...
                        row = {"Name": name, "Industry": r["Industry"], "Year": y, "IsQuarter": True, "Quarter": q}
                        for col in QUARTERLY_ALLOWED_BASE - {"Name", "Industry", "Year", "IsQuarter", "Quarter"}:
