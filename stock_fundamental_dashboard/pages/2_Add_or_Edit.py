...
# Ensure mandatory columns exist so new rows can be added safely
...
if submit_annual:
    ...
    if submit_quarter:
        ...
        # Optional: unify industry fields across this stock
        if new_row["Industry"]:
