...
for stock_name in stocks:
    with st.expander(stock_name, expanded=False):
        ...
        with tabs[0]:
            ...
            _download_json_button("📥 Download Cash-Flow Wealth (FY) JSON", cfw_payload,
                                f"{stock_name}_cash_flow_wealth_fy.json", key=f"cfw_fy_{stock_name}")
            # ---- end Cash Flow Wealth (FY latest) ---------------------------------
